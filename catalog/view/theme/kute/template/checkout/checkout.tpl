...
<div id="columns" class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="panel-group checkout-page" id="accordion">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"><?php echo $text_checkout_option; ?></h4>
          </div>
          <div class="panel-collapse collapse" id="collapse-checkout-option">
            <div class="panel-body box-border"></div>
          </div>
        </div>
...
$(document).delegate('#button-account', 'click', function() {
    $.ajax({
        ...
        dataType: 'html',
        beforeSend: function() {
        	$('#button-account').bootstrapBtn('loading');
		},      
        complete: function() {
			$('#button-account').bootstrapBtn('reset');
        },          
        success: function(html) {
...
$(document).delegate('#button-login', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
        	$('#button-login').bootstrapBtn('loading');
		},  
        complete: function() {
            $('#button-login').bootstrapBtn('reset');
        },              
...
$(document).delegate('#button-register', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
			$('#button-register').bootstrapBtn('loading');
		},  
        complete: function() {
            $('#button-register').bootstrapBtn('reset');
        },          
        success: function(json) {
            $('.alert, .text-danger').remove();
            $('.form-group').removeClass('has-error');
...
$(document).delegate('#button-payment-address', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
        	$('#button-payment-address').bootstrapBtn('loading');
		},  
        complete: function() {
			$('#button-payment-address').bootstrapBtn('reset');
        },          
        success: function(json) {
            $('.alert, .text-danger').remove();
...
$(document).delegate('#button-shipping-address', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
			$('#button-shipping-address').bootstrapBtn('loading');
	    },  
        complete: function() {
			$('#button-shipping-address').bootstrapBtn('reset');
        },          
        success: function(json) {
            $('.alert, .text-danger').remove();
...
$(document).delegate('#button-guest', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
       		$('#button-guest').bootstrapBtn('loading');
	    },  
        complete: function() {
			$('#button-guest').bootstrapBtn('reset');
        },          
        success: function(json) {
            $('.alert, .text-danger').remove();
...
$(document).delegate('#button-guest-shipping', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
        	$('#button-guest-shipping').bootstrapBtn('loading');
		},  
        complete: function() {
			$('#button-guest-shipping').bootstrapBtn('reset');
        },          
        success: function(json) {
            $('.alert, .text-danger').remove();
...
$(document).delegate('#button-shipping-method', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
        	$('#button-shipping-method').bootstrapBtn('loading');
		},  
        complete: function() {
			$('#button-shipping-method').bootstrapBtn('reset');
        },          
        success: function(json) {
            $('.alert, .text-danger').remove();
...
$(document).delegate('#button-payment-method', 'click', function() {
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function() {
         	$('#button-payment-method').bootstrapBtn('loading');
		},  
        complete: function() {
            $('#button-payment-method').bootstrapBtn('reset');
        },          
        success: function(json) {
            $('.alert, .text-danger').remove();
