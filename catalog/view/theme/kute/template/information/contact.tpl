    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?> "><?php echo $content_top; ?>
            ...
            <div id="contact" class="page-content page-contact">
                <div class="col-sm-6">
                    <h3 class="page-subheading"><?php echo $text_contact; ?></h3>
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="contact-form-box">
                        <fieldset>
                            <div class="form-group required form-selector">
                            ...
                            <?php if(isset($captcha) && !empty($captcha)) {?>
                                <?php echo $captcha;?>
                            <?php } else if(isset($entry_captcha) && !empty($entry_captcha)){?>
                            <div class="form-group required form-selector">
                        ...
                        <div class="buttons form-selector">
                            <input id="btn-send-contact" class="btn" type="submit" value="<?php echo $button_submit; ?>" />
                        </div>
                    </form>
                </div>
                <div class="col-sm-6">
                    <h3 class="page-subheading"><?php echo $text_location; ?></h3>
