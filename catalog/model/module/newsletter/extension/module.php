...
class ModelModuleNewsletterExtensionModule extends Model {
    ...
    private function _sendEmailConfirm($data, $filename)
    {
        ...
        $data['url_agree'] = $this->url->link('module/newsletter/index/confirm/&agree&cid='.$encrypt_email, '', 'SSL');
        $data['url_unagree'] = $this->url->link('module/newsletter/index/confirm&unagree&cid='.$encrypt_email, '', 'SSL');
    ...
    {
        return $this->load->view('kute/template/mail/advanced_newsletter/en/'.$filename.'.phtml', $data);
    }
}