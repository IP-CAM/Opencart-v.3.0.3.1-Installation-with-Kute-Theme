    ...
    public function index() {
        ...
        if($this->setting['design']['bootstrap']){
            if($this->language->get('direction') == 'ltr'){
                $this->document->addStyle('catalog/view/theme/kute/stylesheet/d_quickcheckout/bootstrap.css');
            }else{
                $this->document->addStyle('catalog/view/theme/kute/stylesheet/d_quickcheckout/bootstrap.rtl.css');
            }
        }
        if($this->language->get('direction') == 'ltr'){
            $this->document->addStyle('catalog/view/theme/kute/stylesheet/d_quickcheckout/d_quickcheckout.css');
        }else{
            $this->document->addStyle('catalog/view/theme/kute/stylesheet/d_quickcheckout/d_quickcheckout.rtl.css');
        }
        
        $this->document->addStyle('catalog/view/theme/kute/stylesheet/d_quickcheckout/theme/'.$this->setting['design']['theme'].'.css');
