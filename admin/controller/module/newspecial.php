...
class ControllerModuleNewSpecial extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				$this->model_extension_module->addModule('newspecial', $this->request->post);
			} else {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('module/newspecial', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('module/newspecial', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/newspecial')) {
