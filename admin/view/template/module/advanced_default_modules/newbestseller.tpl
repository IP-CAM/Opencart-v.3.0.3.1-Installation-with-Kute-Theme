            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-bestseller" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-image"><?php echo 'Banner sales'; ?></label>
                            <div class="col-sm-10">
                                <select name="banner_id" id="input-image" class="form-control">
                                    <option value="0">----</option>
                                    <?php if(is_array($banners) && count($banners) > 0) { ?>
                                        <?php foreach ($banners as $banner) { ?>
                                            <option value="<?php echo $banner['banner_id']?>" <?php echo ($banner_id == $banner['banner_id'] ? 'selected="selected"' : '')?>><?php echo $banner['name']?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
