...
abstract class Core_ORM
{
     ...
     * @param $string
     */
    public function _init($string_id, $table)
    {
        Core_ORM::$pk = $string_id;
        Core_ORM::$table = $table;
    }
    ...
    public static function getTableName ()
    {
        ...
        if (isset($className::$table))
            return DB_PREFIX.$className::$table;
        // assumed config
        return strtolower(DB_PREFIX.$newClassName);
    }
     ...
     * @return mixed
     */
    public static function sql ($sql, $return = Core_ORM::FETCH_MANY)
    {
        // shortcuts
    ...
    {
        $count = self::sql($sql, Core_ORM::FETCH_ONE);
    ...
    {
        self::sql('TRUNCATE :database.:table', Core_ORM::FETCH_NONE);
    }
    ...
    public static function retrieveByPK ($pk)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($pk, Core_ORM::LOAD_BY_PK));
    }
    ...
    public static function hydrate ($data)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($data, Core_ORM::LOAD_BY_ARRAY));
    }
     ...
     * @return mixed
     */
    public static function retrieveByField ($field, $value, $return = Core_ORM::FETCH_MANY)
    {
        if (!is_string($field))
